...
Trying to make more functions so it works on all networks.

# Usage
#### Installing on the system
```bash
git clone https://github.com/zyphcore/Wifi-DeAuth.git
cd wifi-deauth
sudo pip3 install .
...
* `--deauth-all-channels` - try this option if the attack doesn't work 
